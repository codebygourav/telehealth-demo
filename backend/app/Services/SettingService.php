...
class SettingService
{
    ...
    */
    ...
    {
        return Setting::getValue('app', 'primary_color', '#B51E23');
    }

    public static function getSecondaryColor(): string
    {
        return Setting::getValue('app', 'secondary_color', '#B51E23');
    }
    ...
    */
    ...
    public static function getPublicSettings(): array
    {
        return [
            ...
            'patient_theme' => [
                'primary_color' => self::getThemeValue('patient_primary_color', '#B51E23'),
                'secondary_color' => self::getThemeValue('patient_secondary_color', '#B51E23'),
                'logo' => self::getThemeFileUrl('patient_logo'),
                'favicon' => self::getThemeFileUrl('patient_favicon'),
            ],
            'doctor_theme' => [
                'primary_color' => self::getThemeValue('doctor_primary_color', '#B51E23'),
                'secondary_color' => self::getThemeValue('doctor_secondary_color', '#B51E23'),
